...
public class BluetoothLogService {
  ...
  private void connectionFailed() {
    Message localMessage = mHandler.obtainMessage(SpeechActivity.MESSAGE_TOAST);
  ...
  private void connectionLost() {
    Message localMessage = this.mHandler.obtainMessage(SpeechActivity.MESSAGE_TOAST);
    Bundle localBundle = new Bundle();
  ...
  private synchronized void setState(int state) {
      ...
      mHandler.obtainMessage(SpeechActivity.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
  }
  ...
  public synchronized void connected(BluetoothSocket socket, BluetoothDevice
      ...
      Message msg = mHandler.obtainMessage(SpeechActivity.MESSAGE_DEVICE_NAME);
      Bundle bundle = new Bundle();
      bundle.putString(SpeechActivity.DEVICE_NAME, device.getName());
      msg.setData(bundle);
  ...
  private class ConnectedThread extends Thread {
      ...
      public void write(byte[] buffer) {
          try {
              ...
              mHandler.obtainMessage(SpeechActivity.MESSAGE_WRITE, -1, -1, buffer)
                      .sendToTarget();
          } catch (IOException e) {
